      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-sm text-slate-300 leading-relaxed">
          ...
          <section>
            ...
            <p>Bem-vindo à Plataforma Gabi, operada pela ness<span className="text-[#00ade8]">.</span> Respeitamos a sua privacidade e estamos comprometidos em proteger de forma rígida seus dados pessoais e organizacionais. Esta política detalha como coletamos, utilizamos e protegemos as suas informações no ecossistema de inteligência artificial.</p>
          </section>
          ...
          <section>
            ...
            <p>Seus dados são encriptados e usados exclusivamente para fornecer resultados customizados de inteligência artificial para a sua navegação (como responder chamados, buscar regulamentos na sua base de conhecimento e emular seu tom de escrita). <strong>A ness<span className="text-[#00ade8]">.</span> não vende dados sob hipótese alguma.</strong></p>
          </section>
