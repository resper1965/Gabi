...
## Repository map
- `api/` — explain what lives here and when agents should edit it.
- `cloudbuild-web.yaml/` — explain what lives here and when agents should edit it.
- `cloudbuild.yaml/` — explain what lives here and when agents should edit it.
- `docs/` — explain what lives here and when agents should edit it.
- `nghost/` — explain what lives here and when agents should edit it.
- `packages/` — explain what lives here and when agents should edit it.
- `pr1.json/` — explain what lives here and when agents should edit it.
- `prs_all.json/` — explain what lives here and when agents should edit it.
