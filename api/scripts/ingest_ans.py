...
SOURCE_NORM = IngestSource.ANS_NORM

ANS_MOCK_DOCS = [
    {
        "Url": "https://www.ans.gov.br/component/legislacao/?view=legislacao&task=TextoLei&format=raw&id=4028",
        "Tipo": "Resolução Normativa",
        "Numero": "465",
        "Ano": "2021",
        "Titulo": "RN 465 - Rol de Procedimentos"
    }
]

async def run_ans_ingestion():
    print(f"Buscando Normativos da ANS...")
    client = BCBClient()
    
    docs_to_process = ANS_MOCK_DOCS
    ...
    print("Ingestão da ANS concluída.")
